...
android {
    ...
    compileOptions {
        ...
        // flutter_local_notifications requires this — see its own
        // android/build.gradle's `coreLibraryDesugaring` dependency.
        isCoreLibraryDesugaringEnabled = true
    }

    defaultConfig {
        // TODO: Specify your own unique Application ID (https://developer.android.com/studio/build/application-id.html).
        applicationId = "com.bytebridgemw.farmis_mobile"
